...
export const SocialRegistration = (
  ...
  return async dispatch => {
    try {
      ...
      console.log('socialRegistrationResponseData==success==', socialRegistrationResponseData);

      if (socialRegistrationResponseData) {
        const data = socialRegistrationResponseData ? socialRegistrationResponseData : '';
        if (data.status) {
          ...
          console.log('socialRegistrationResponse=30==', socialRegistrationResponse);
...
export const socialLogin = (deviceID, deviceName, FCM_Token, type, social_id, email) => {
  ...
  return async dispatch => {
    try {
      ...
      console.log('socialLoginResponseData==success==', socialLoginResponseData);
...
export const ForgotPassword = (token, id, password, confirm_password) => {
  return async dispatch => {
    try {
      const forgotPasswordResponseData = await forgotPasswordAPI(token, id, password, confirm_password);
      console.log('forgotPasswordResponseData==success==', forgotPasswordResponseData);

      if (forgotPasswordResponseData) {
        const data = forgotPasswordResponseData ? forgotPasswordResponseData : '';
        if (data.status) {
